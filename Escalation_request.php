...
include("config.php");
// echo $id=$_GET['id'];die;
$result=mysqli_query($mysqli,"SELECT* from `procedure`");
...
<html lang="en">
   ...
   <body class="inner_page map">
      <div class="full_container">
       ...
       <td><?php echo $data['escalation_level']; ?></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="image-header">
          <h4 class="modal-title">Escalation Request Information... </h4>
        ...
        <div class="modal-body">
            Complaint ID:
        <?php echo $data['complaint_id']; ?><br>
        Escalation Level:
        <?php echo $data['escalation_level']; ?><br>
        Subject:
        <?php echo $data['subject']; ?><br>
       
        Messege:
        <?php echo $data['messege'];?><br>
