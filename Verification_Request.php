...
//$result=mysqli_query($mysqli,"SELECT* from project");
 ...
 if(!empty($_GET)){
    ...
    $result=mysqli_query($mysqli,"SELECT* from process WHERE isVerify = 0");
}
...
<html lang="en">
  ...
  <!--  <td> <?php echo $data['details']; ?></td>-->
    ...
    <p style="color:white">View details  </p> </button></td>
      ...
      <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal-<?=$data['id']?>"style="height:30px;">
      <p style="color:white">View File</p>
  </button></td>
       <td><button class="btn btn-success" onclick="functionMy(<?=$data['id']?>)"style="height:30px;"><p style="color:white">Verify</p></button></td>

       <td><button class="btn btn-danger" onclick="functionM1(<?=$data['id']?>)"style="height:30px;"><p style="color:white">Reject</p></button></td>
...
<div class="modal" id="myModals-<?=$data['id']?>">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        Transaction ID:
        <?php echo $data['transaction_id'];?><br>
        </div>
